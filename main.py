...
class snapchat:
    ...
    def update_title(self, shortcut_users):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(f"Snapchat Score Botter | Sent Snaps: {sent_snaps} | Elapsed: {elapsed}s | Developed by Plutobear")
    ...
    def main(self):
        os.system("cls")
        ctypes.windll.kernel32.SetConsoleTitleW("Snapchat Score Botter | Developed by Plutobear")
